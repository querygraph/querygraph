...
4. Run groff with `-Tpdf -P-e -t -ms`.
5. If Ghostscript is present, re-embed fonts after groff output.
6. Generate EPUB/MOBI for both stems when the reading surface should compare
   the formatter variants.
7. Record both variants in `dist/VERSION.md`.
